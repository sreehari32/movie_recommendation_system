...
1. ## Loading of Data
   ...
   # The information regrading the movies are obrained from two datasets, namely credits and movies. Both csv files are uploaded to      dataframes
...
3. ## Data Preprocessing
   ...
   The values in the columns are stored as dictionaries. These values are extracted using customised function and new columsn are made for further easy processings
